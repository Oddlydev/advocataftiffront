        ...
        switch (domNode.name) {
          ...
          case "a":
            return (
              <a
                {...domNode.attribs}
                className="text-brand-1-500 underline underline-offset-4 transition-colors mx-auto max-w-4xl px-5 md:px-10 xl:px-16"
              >
                {domToReact(domNode.children, options)}
              </a>
            );
          ...
          case "ol":
            return (
              <ol className="list-decimal pl-6 ml-6 space-y-3 text-slate-600 text-lg/7 font-sourcecodepro font-normal py-2 mx-auto max-w-4xl px-5 md:px-10 xl:px-16">
                {domToReact(domNode.children, options)}
              </ol>
            );
          ...
          case "ul":
            return (
              <ul className="ml-6 space-y-3 text-slate-600 text-lg/7 font-sourcecodepro font-normal py-2 mx-auto max-w-4xl px-5 md:px-10 xl:px-16">
                {domToReact(domNode.children, options)}
              </ul>
            );
          ...
          return (
            <div className="mx-auto max-w-4xl py-4 px-5 md:px-10 xl:px-16">
              <blockquote
                className={
                  variant === "single"
                    ? "italic font-medium border-slate-200 border-l-4 py-3 px-4"
          ...
          case "figure": {
            ...
            return (
              <figure className={figureClass}>
                ...
                {captionNode && (
                  <figcaption
                    className={`mt-3 text-sm text-slate-500 font-sourcecodepro text-center flex items-center justify-center gap-2 ${
                      isFullWidth ? "relative w-screen max-w-full mx-auto full-width-img" : "relative w-screen max-w-full mx-auto full-width-img"
                    }`}
                  >
                    <svg
          ...
          case "img": {
            ...
            if (isFullWidth) {
              ...
              imgClass += "w-full max-w-4xl mx-auto";
            }
