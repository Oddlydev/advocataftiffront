    ...
    <article className="w-full rounded-[16px] border border-[#BFDBFE] bg-gradient-to-r from-[#EFF6FF] to-[#EEF2FF] p-4 shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_-1px_rgba(0,0,0,0.1)]">
      <div className="flex gap-4">
        ...
        <div className="flex flex-1 flex-col gap-2">
          ...
          >
            These insights are AI-generated and may contain errors. Always
            verify critical findings with source data. Your data is analyzed
            locally and not shared or stored beyond this session.
          </p>
        </div>
      </div>
    </article>
