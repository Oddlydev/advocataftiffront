  ...
  return (
    <div
      className={clsx(
        ...
        // paragraphs + inline
        "[&_p]:text-slate-600 [&_p]:font-sourcecodepro [&_p]:font-normal [&_p]:text-lg/7 [&_p]:pb-6 [&_p]:pt-6",
        ...
        "[&_ul]:ml-6 [&_ul]:space-y-3 [&_ul]:text-slate-600 [&_ul]:text-lg/7 [&_ul]:font-normal [&_ul]:font-sourcecodepro [&_ul]:py-2",
        ...
        // blockquote
        "[&_blockquote]:text-lg/7 [&_blockquote]:font-sourcecodepro [&_blockquote]:text-slate-600 [&_blockquote]:font-normal [&_blockquote]:border-brand-2-50 [&_blockquote]:border-l-4 [&_blockquote]:lg:pl-8 [&_blockquote]:py-3",
        "[&_blockquote>p]:py-0",

        // meta span row
        "[&_span]:flex [&_span]:items-center [&_span]:gap-1 [&_span]:text-slate-500 [&_span]:text-xs [&_span]:leading-4 [&_span]:font-normal [&_span]:font-sourcecodepro [&_span]:mb-2",
