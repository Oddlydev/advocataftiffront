...
export const WysiwygInner: React.FC<WysiwygInnerProps> = ({
  ...
  return (
    <div
      className={clsx(
        // headings
        "[&_h2]:text-slate-950 [&_h2]:font-montserrat [&_h2]:font-bold [&_h2]:text-2xl [&_h2]:lg:text-5xl [&_h2]:leading-snug [&_h2]:mb-6",
        "[&_h3]:text-slate-950 [&_h3]:font-montserrat [&_h3]:font-bold [&_h3]:text-xl [&_h3]:lg:text-3xl [&_h3]:leading-snug [&_h3]:mt-6",

        // paragraphs + inline
        "[&_p]:text-slate-600 [&_p]:font-baskervville [&_p]:font-normal [&_p]:text-lg/7 [&_p]:pb-6 [&_p]:pt-6",
        "[&_p>a]:text-secondary [&_p>a]:underline",
        "[&_p>span]:text-brand-black",

        // ordered lists
        "[&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:ml-6 [&_ol]:space-y-3 [&_ol]:text-slate-600 [&_ol]:text-lg/7 [&_ol]:font-normal [&_ol]:font-baskervville [&_ol]:py-2",
        ...
        "[&_ul]:ml-6 [&_ul]:space-y-3 [&_ul]:text-slate-600 [&_ul]:text-lg/7 [&_ul]:font-normal [&_ul]:font-baskervville [&_ul]:py-2",
        ...
        // blockquote
        "[&_blockquote]:text-lg/7 [&_blockquote]:font-baskervville [&_blockquote]:text-slate-600 [&_blockquote]:font-normal [&_blockquote]:border-brand-2-50 [&_blockquote]:border-l-4 [&_blockquote]:lg:pl-8 [&_blockquote]:py-3",
        "[&_blockquote>p]:py-0",

        // meta span row
        "[&_span]:flex [&_span]:items-center [&_span]:gap-1 [&_span]:text-slate-500 [&_span]:text-xs [&_span]:leading-4 [&_span]:font-normal [&_span]:font-baskervville [&_span]:mb-2",
