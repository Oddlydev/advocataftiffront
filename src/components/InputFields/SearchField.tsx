  ...
  return (
    <div className={"relative w-full " + (className || "")}>
      <input
        ...
        className={`search-input w-full rounded-full border border-gray-300 bg-white py-2.5 pl-12 pr-2.5 font-family-baskervville text-sm/tight md:text-base/6 text-slate-800 placeholder:text-slate-600/50 shadow-sm hover:border-brand-1-100 focus:border-brand-1-200 focus:outline-0 focus:outline-brand-1-200 focus:ring-1 focus:ring-transparent ${showSubmitButton ? "pr-28" : "pr-2.5"} font-family-baskervville text-sm md:text-base text-slate-800 placeholder:text-slate-600/50 shadow-sm hover:border-brand-1-100 focus:border-brand-1-200 focus:outline-0 focus:ring-1 focus:ring-transparent`}
        value={query}
