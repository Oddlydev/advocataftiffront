...
const ForeignReservesChart = () => {
  ...
  useEffect(() => {
    ...
    svg
      ...
      .attr("class", "font-sourcecodepro text-slate-600 text-lg font-normal")
      .text("Official Reserve Assets (USD Mn.)");
            ...
            <div class="flex flex-col gap-1">
              ...
              <div class="flex items-center justify-between gap-2">
                <div class="flex items-center gap-1">
                  ...
                  <span class="text-slate-600 font-sourcecodepro font-normal text-xs">ORA:</span>
                </div>
                <span style="color:${color};" class="text-xs font-sourcecodepro font-normal">${d.ORA}%</span>
              </div>
            </div>
          `);
            ...
            <div className="px-6 py-7">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border-b border-brand-1-100 pb-4 md:border-b-0 md:border-r md:pr-4">
                  ...
                  <div className="space-y-5 text-slate-800 text-base/6 font-baskervville font-normal">
                    <p className="text-slate-800 text-base/6 font-baskervville font-normal">
                      Total Annual Foreign Reserves represent the cumulative
                      reserve asset position of the Central Bank of Sri Lanka as
                      of 31st December each year, expressed in millions of US
                      dollars. It includes international reserves held by the
                      government and central monetary authority.
                    </p>
                    <p className="text-slate-800 text-base/6 font-baskervville font-normal">
                      Foreign reserves are critical for economic stability,
                      exchange rate management, international trade, and
                      confidence in national financial resilience. Adequate
                      reserves support government capacity to meet external
                      obligations and manage economic shocks.
                    </p>
                  </div>
                </div>
                <div className="mt-6 md:mt-0">
                  ...
                  <div className="space-y-5 text-slate-800 text-base/6 font-baskervville font-normal">
                    <p className="text-slate-800 text-base/6 font-baskervville font-normal">
                      Foreign reserves include assets such as foreign
                      currencies, gold reserves, Special Drawing Rights (SDRs),
                      and other reserve assets maintained by the Central Bank of
                      Sri Lanka. The value is reported annually based on asset
                      valuation as of the 31st December.
                    </p>
                  </div>
                </div>
              </div>
