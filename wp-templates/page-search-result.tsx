  ...
  return (
    <div className="bg-white">
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10 xl:px-16 pb-10">
        {loading ? (
          <p className="text-center text-base/6 md:text-lg/7 font-normal text-slate-600 font-sourcecodepro">
            Loading results...
          </p>
        ) : search.trim() === "" ? (
            ...
            <div className="mx-auto max-w-4xl px-5 md:px-10 xl:px-16 pt-8 pb-10 lg:pt-12 lg:pb-20">
              <div className="text-center space-y-2">
                <h1 className="text-3xl md:text-5xl leading-snug font-bold font-montserrat text-brand-black">
                  Type in a search term to begin
                </h1>
                <p className="text-base/6 md:text-lg/7 font-normal font-baskervville text-slate-800 max-w-xl mx-auto">
                  Looks like your search field is empty. Try a broader keyword.
                </p>
              </div>

              {/* Popular Pages */}
              <div className="mt-12">
                <span className="text-gray-500 text-sm/tight uppercase font-semibold font-sourcecodepro mb-4">
                  Popular Pages
                </span>

                <nav
                  className="sidebar-fill flex flex-1 flex-col mt-6"
                  aria-label="Sidebar"
                >
                  <ul
                    role="list"
                    className="border-b border-slate-600/10 -mx-2 space-y-2"
                  >
                    <li className="border-t border-slate-600/10">
                      ...
                      >
                        <div className="bg-brand-1-50 group-hover:bg-white group rounded-lg p-3">
                          <svg
                            className="sidebar-item-icon size-6 shrink-0 text-brand-1-700 "
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                            viewBox="0 0 24 24"
                        ...
                        <div>
                          <h3 className="text-slate-950 text-lg leading-snug font-semibold font-montserrat">
                            Government Fiscal Operations
                          </h3>
                          <p className="text-slate-600 text-base/6 font-normal font-baskervville max-w-md">
                            A detailed overview of government revenue,
                            expenditure, and fiscal performance.
                          </p>
                        </div>
                        <span
                          className="idebar-item-arrow absolute top-2/5 right-2"
                          aria-hidden="true"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li className="border-t border-slate-600/10">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-slate-600 text-base/6 font-normal font-baskervville max-w-md">
                            Key indicators and trends shaping Sri Lanka’s
                            economic landscape.
                          </p>
                        </div>
                        <span
                    ...
                    <li className="border-t border-slate-600/10">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-slate-600 text-base/6 font-normal font-baskervville max-w-md">
                            Data and insights that promote accountability in
                            public institutions.
                          </p>
                        </div>
                        <span
          ...
          // 👇 Only show "no results" if search is not empty and we are NOT loading
          search.trim() !== "" &&
          !loading && (
            <div className="bg-white">
              <div className="mx-auto max-w-4xl px-5 md:px-10 xl:px-16 pt-8 pb-10 lg:pt-12 lg:pb-20">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-base/6 md:text-lg/7 font-normal font-baskervville text-slate-800 max-w-xl mx-auto">
                    Looks like nothing matches your search. Try a broader
                    keyword.
                  </p>
                </div>
