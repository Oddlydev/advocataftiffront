...
const UnemploymentChart = () => {
  ...
  useEffect(() => {
    ...
    // Animate dots along the line & attach tooltip
    data.forEach((d, i) => {
      const dot = svg
        .append("circle")
        .attr("cx", x(d.year)!)
          ...
          <div class="flex flex-col gap-1">
            ...
            <div class="flex items-center justify-between gap-2">
              <div class="flex items-center gap-1">
                ...
                <span class="text-slate-600 font-sourcecodepro font-normal text-xs">Unemployment Rate:</span>
              </div>
              <span style="color:${color};" class="text-xs font-sourcecodepro font-normal">${d.UnemploymentRate}%</span>
            </div>
          </div>
        `);
            ...
            <div className="px-6 py-7">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border-b border-brand-1-100 pb-4 md:border-b-0 md:border-r md:pr-4">
                  ...
                  <div className="space-y-5 text-slate-800 text-base/6 font-baskervville font-normal">
                    <p className="text-slate-800 text-base/6 font-baskervville font-normal">
                      The Annual Unemployment Rate represents the percentage of
                      the total labor force that is unemployed and actively
                      seeking employment within Sri Lanka, averaged annually. It
                      reflects the proportion of individuals within the labor
                      market who are willing and able to work but do not have
                      employment.
                    </p>
                  </div>
                </div>
                <div className="mt-6 md:mt-0">
                  ...
                  <div className="space-y-5 text-slate-800 text-base/6 font-baskervville font-normal">
                    <p className="text-slate-800 text-base/6 font-baskervville font-normal">
                      The unemployment rate is calculated by dividing the number
                      of unemployed persons by the total labor force and
                      multiplying by 100. An unemployed person is defined as
                      someone who is actively seeking and available for work but
                      unable to find employment during the reference period of
                      the survey.
                    </p>
                  </div>
                </div>
